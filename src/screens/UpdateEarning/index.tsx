...
export const UpdateEarning = () => {
  ...
  const idEarning = route.params?.id
  ...
  const deleteExpense = () => {
    database.collection('Earning').doc(idEarning).delete()
    navigation.navigate("Earnings" as never, {idUser: route.params.userId})
  }
  ...
  const onSubmit = (data: ExpensesType) => {
    ...
    database.collection('Earning').doc(idEarning).update({
      title: data.title,
      ...
      ToastAndroid.show('Ganho atualizado com sucesso!',
      ToastAndroid.SHORT
    );
  }
  ...
  return (
    <KeyboardAwareScrollView>
      <View style={styles.container}>
        <FormHeader title="Atualizar Ganho"/>
